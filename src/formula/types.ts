...
export interface TSubExpr_variable_dyn {
  type: 'variable_dyn';
  expr: TExpr[];
  position: number;
}
export interface TSubExpr_variable {
  type: 'variable';
  name: string;
  position: number;
}
export type TSubExpr =
  | TSubExpr_function
  | TSubExpr_variable_dyn
  | TSubExpr_variable;

export interface TExpr_parentheses {
  type: 'parentheses';
  expr: TExpr[];
  subexpr: TSubExpr[];
}
export interface TExpr_number {
  type: 'number';
  number: number;
  subexpr: TSubExpr[];
}
export interface TExpr_string {
  type: 'string';
  text: string;
  subexpr: TSubExpr[];
}
export interface TExpr_array {
  type: 'array';
  arguments: TExpr[][];
  subexpr: TSubExpr[];
}
export interface TExpr_object {
  type: 'object';
  object: { [key: string]: TExpr[] };
  subexpr: TSubExpr[];
}
export interface TExpr_variable {
  type: 'variable';
  name: string;
  position: number;
  subexpr: TSubExpr[];
...
export interface TExpr_operator {
  type: 'operator';
  name: TOperators;
  position: number;
}
