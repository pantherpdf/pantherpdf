...
test('SetVar', async () => {
	const dt: ForceChildren<SetVarData|TextSimpleData> = {type:'SetVar', source:'data.abc.def', varName: 'ccc', children:[
...
test('SetVar check that childs of data are not accessible', async () => {
	const dt: ForceChildren<SetVarData|TextSimpleData> = {type:'SetVar', source:'abc.def', varName: 'ccc', children:[
