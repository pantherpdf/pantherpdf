...
test('UpdateVar SetVar', async () => {
	const dt: ForceChildren<SetVarData|TextSimpleData|RepeatData|UpdateVarData> = {type:'SetVar', source:'1', varName: 'ccc', children:[
		{type:'TextSimple', formula:'ccc', children:[]},
		{type:'Repeat', source:'[1,2,3,4,5]', varName:'item', children:[
			{type:'UpdateVar', varName:'ccc', formula:'ccc + 1', children:[]},
		]},
		{type:'TextSimple', formula:'ccc', children:[]},
	]}
